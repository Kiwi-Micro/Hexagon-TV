		...
		<div className="main">
			...
			<div className="videoPage heroContainer">
				...
				<div className="homePageHeroInfo">
					...
					{isInWatchlist ? (
						<svg width="32" height="32" viewBox="0 0 16 16" style={{ fill: "#ffffff", marginLeft: "10px", position: "relative", top: "10px" }} xmlns="http://www.w3.org/2000/svg" onClick={() => removeFromWatchlist(urlName, setIsInWatchlist)}>
						...
						<svg width="32" height="32" viewBox="0 0 16 16" style={{ fill: "#ffffff", marginLeft: "10px", position: "relative", top: "10px" }} xmlns="http://www.w3.org/2000/svg" onClick={() => addToWatchlist(name, urlName, thumbnailURL, setIsInWatchlist)}>
