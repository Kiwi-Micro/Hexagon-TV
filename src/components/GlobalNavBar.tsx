				...
				{!isSearchPage && (
					<li className="navLink" style={{ position: "fixed", right: "10px" }}>
						<div className="searchBar" style={{ marginInline: "auto" }}>
							...
							<input type="text" value={query} onChange={(e) => handleSearchChange(e)} onClick={() => handleSearchClick()} onBlur={() => setShouldShowResults(false)} onKeyDown={(e) => handleKeyDown(e)} placeholder="Search" />
